...
namespace BookStore.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        // GET: Products
        public ViewResult Index(string sortOrder, string searchString, HotelLocation productCatergory)
        {
        ...
        // GET: Products/Create
        public ActionResult Create(Products product, HotelLocation productCatergory)
        {
        ...
        public ActionResult Create([Bind(Include = "ProductCatergoryId,CatergoryName,ProductCatergory,ProductPrice,ProductImage,ProductDescription,ProductStock,ProductAuthor,ProductName,ProductCatergory")] Products product, HttpPostedFileBase img_upload, HotelLocation productCatergory)
        {
